...
![Problems](https://img.shields.io/badge/problems-92-orange?style=flat-square)
...
| 87 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/87_clip_loss_pdd260702.ipynb" target="_blank">CLIP Contrastive Loss</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/87_clip_loss_pdd260702.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `clip_loss(image_embeds, text_embeds, temperature)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Symmetric InfoNCE, image↔text logits `/τ`, diagonal-label bidirectional CE |
| 96 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/96_pca_anomaly_oppo260808.ipynb" target="_blank">PCA Anomaly Detection</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/96_pca_anomaly_oppo260808.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `detect_anomaly(train, test)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Mean-impute (train stats), StandardScaler, PCA(0.95) reconstruction error, 95th-percentile threshold |
...
| 78 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/78_dyson_energy.ipynb" target="_blank">Dyson Ring Energy Transport</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/78_dyson_energy.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.max_energy(start, fuel, positions, energies)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Turn-once route, interval `[L,R]` + prefix sum, fuel cost `(R-L)+min(...)` |
| 79 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/79_nearest_dining.ipynb" target="_blank">Nearest Free Dining Spot</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/79_nearest_dining.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.nearest_free_distance(p, intervals)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | 💡 | Merge closed integer intervals (gap≤1), nearest block edge |
| 80 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/80_magic_vine.ipynb" target="_blank">Magic Vine Cutting</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/80_magic_vine.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.min_operations(a)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Prefix DP, running max/min last-occurrence, `dp[k]=1+min(...)` |
| 81 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/81_signed_permutation_ali260509.ipynb" target="_blank">Signed Permutation (Sum Zero)</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/81_signed_permutation_ali260509.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.construct(n)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Parity feasibility `n%4∈{1,2}` impossible, zero-sum quadruple tiling |
| 82 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/82_maze_signposts_ali260509.ipynb" target="_blank">Maze Signposts</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/82_maze_signposts_ali260509.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.exit_sides(signs)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Invariant: `cntL` balls exit left, answer `'L'*cntL+'R'*rest` |
| 83 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/83_xab_ali260509.ipynb" target="_blank">xab (Max XOR Pair Count)</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/83_xab_ali260509.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.count_best_pairs(x, la, ra, lb, rb)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | 💡 | Digit DP, high-bit greedy XOR, 16-state bound-tightness mask |
| 84 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/84_diagonal_traversal_pdd260702.ipynb" target="_blank">Diagonal Traversal (Bottom-Left)</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/84_diagonal_traversal_pdd260702.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.diagonal_order(mat)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | 💡 | Anti-diagonal sweep `i-j=d`, alternating scan direction |
| 85 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/85_rescue_pdd260702.ipynb" target="_blank">Rescue Operation</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/85_rescue_pdd260702.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.min_remaining(n, monitors)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Fixed-point peeling, in-degree-0 single kill + mutual-pair double kill |
| 86 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/86_fly_catching_pdd260702.ipynb" target="_blank">Catch the Fly</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/86_fly_catching_pdd260702.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.min_cost(a, c)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Functional graph, topological peel to cycles, sum of per-cycle min cost |
| 88 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/88_switch_lights_bd260723.ipynb" target="_blank">开关控制灯</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/88_switch_lights_bd260723.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.min_ops(a)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | 💡 | Left-to-right greedy, forced press by carry parity, `cur = a[i] ^ prev` |
| 89 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/89_grid_walk_flip_bd260723.ipynb" target="_blank">格子行走翻转</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/89_grid_walk_flip_bd260723.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.changed_grids(n, s)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | 💡 | Prime base color ⊕ flip parity, per-person walk simulation |
| 90 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/90_bracket_elimination_bd260730.ipynb" target="_blank">括号分层消除</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/90_bracket_elimination_bd260730.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.rounds(s)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | 💡 | Nesting depth = round, `round = D - d + 1`, single scan |
| 91 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/91_remainder_walk_bd260730.ipynb" target="_blank">余数行走</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/91_remainder_walk_bd260730.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.total_length(n, M, a)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Prefix remainders on doubled array, sliding window of distinct values |
| 92 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/92_max_product_bd260730.ipynb" target="_blank">最大乘积操作</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/92_max_product_bd260730.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.max_product(a, k)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | 💡 | Greedy decrement max, level-by-level lowering, fast-power mod `1e9+7` |
| 93 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/93_max_fluctuation_bd260806.ipynb" target="_blank">波动贡献最大化</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/93_max_fluctuation_bd260806.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.max_total(v)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | 💡 | Bound `(max-min)*len`, one whole segment is optimal |
| 94 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/94_min_hedge_bd260806.ipynb" target="_blank">最小对冲值</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/94_min_hedge_bd260806.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.min_hedge(m)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | `a+b=(a^b)+2(a&b)`, balanced split, `(m//2)^((m+1)//2)` |
| 95 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/95_permutation_reset_bd260806.ipynb" target="_blank">消息置换复位</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/95_permutation_reset_bd260806.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `Solution.min_reset(n, u, p)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 💡 | Cycle decomposition, per-cycle min rotation period, LCM mod `1e9+7` |
